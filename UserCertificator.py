...
FolderPrivate = PATH + "/UserCertificator"


class UserCertificator:
    """
    Clase de la entidad UserCertificator
    """
    ...
    def __init__(self):
        ...
        print("Certificado de UserCertificator = ", self.certificate)
    ...
    def cargar_o_generar_clave_privada(self):
        ...
        archivo_nombre= f"{FolderPrivate}/user_private.pem"
        try:
    ...
    def cargar_o_generar_clave_publica(self):
        ...
        archivo_nombre = f"{FolderPrivate}/user_public.pem"
        try:
            with open(archivo_nombre, 'rb') as archivo:
    ...
    def solicitar_certificado(self):
        ...
        archivo_nombre = PATH+"/UserCertificator/user_certifado.pem"
        try:
            with open(archivo_nombre, 'rb') as archivo:
            ...
            # Si no tiene certificado genera una solicitud y la envía para que se la firmen
            csr = x509.CertificateSigningRequestBuilder().subject_name(x509.Name([
                    x509.NameAttribute(NameOID.COUNTRY_NAME, "AN"),
                    x509.NameAttribute(NameOID.STATE_OR_PROVINCE_NAME, "Escaldes-Engordany"),
                    x509.NameAttribute(NameOID.LOCALITY_NAME, "Escaldes-Engordany"),
                    x509.NameAttribute(NameOID.ORGANIZATION_NAME, "Cert"),
                    x509.NameAttribute(NameOID.COMMON_NAME, "certificar_usuarios.com"),])
